...
class XPoster {
  constructor(options = {}) {
    ...
    if (!apiKey || !apiSecret || !accessToken || !accessSecret) {
      if (!dryRun) {
        throw new Error('X API credentials are required. Set TWITTER_API_KEY, TWITTER_API_SECRET, TWITTER_ACCESS_TOKEN, and TWITTER_ACCESS_SECRET environment variables.');
      }
